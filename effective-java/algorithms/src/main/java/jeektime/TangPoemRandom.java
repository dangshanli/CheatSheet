...
/**
 * @author luzj
 * @description: 字符串生成器 李白诗
 * @date 2019/5/31
 */
public class TangPoemRandom implements Generator<String> {
    public static void main(String[] args) {
        Generator<String> t = new TangPoemRandom();
        for (int i = 0; i < 10; i++) {
    ...
    private String[] poem = s.split("[，。]");
    private static Random random = new Random();

    @Override
    public String next() {
        return poem[random.nextInt(165)];
    }

    private static String s = "天上白玉京，十二楼五城。仙人抚我顶，结发受长生。" +
